...
void plogical_shift_rightTests() {
  ...
  dynHalfIntTemplateTest(3, FUN2TEST, (Packet4i)(__m128i)ihvmax.r);
  dynHalfIntTemplateTest(3, FUN2TEST, (Packet4i)(__m128i)ihv36.r);
  dynHalfIntTemplateTest(3, FUN2TEST, (Packet4i)(__m128i)ihv0.r);
  dynHalfIntTemplateTest(3, FUN2TEST, (Packet4i)(__m128i)ihv_240.r);
  dynHalfIntTemplateTest(3, FUN2TEST, (Packet4i)(__m128i)ihvmin.r);
  ...
  dynFullIntTemplateTest(3, FUN2TEST, (Packet8i)(__m256i)ivmax.r);
  dynFullIntTemplateTest(3, FUN2TEST, (Packet8i)(__m256i)iv36.r);
  dynFullIntTemplateTest(3, FUN2TEST, (Packet8i)(__m256i)iv0.r);
  dynFullIntTemplateTest(3, FUN2TEST, (Packet8i)(__m256i)iv_240.r);
  dynFullIntTemplateTest(3, FUN2TEST, (Packet8i)(__m256i)ivmin.r);
  ...
  dynFullLongTemplateTest(3, FUN2TEST, (Packet4l)(__m256i)lvmax.r);
  dynFullLongTemplateTest(3, FUN2TEST, (Packet4l)(__m256i)lv36.r);
  dynFullLongTemplateTest(3, FUN2TEST, (Packet4l)(__m256i)lv0.r);
  dynFullLongTemplateTest(3, FUN2TEST, (Packet4l)(__m256i)lv_240.r);
  dynFullLongTemplateTest(3, FUN2TEST, (Packet4l)(__m256i)lvmin.r);
