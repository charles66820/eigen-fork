...
#ifndef EIGEN_MIPP_PCMP_LT_TEST_H
#define EIGEN_MIPP_PCMP_LT_TEST_H

#undef FUN2TEST
#define FUN2TEST pcmp_lt
...
void pcmp_ltTests() {
  ...
  allTwoPermRep(vectorHalfIntTest, FUN2TEST, (__m128i)ihvmax.r, (__m128i)ihv36.r, (__m128i)ihv0.r, (__m128i)ihv_240.r, (__m128i)ihvmin.r);
  ...
  allTwoPermRep(vectorFullIntTest, FUN2TEST, (__m256i)ivmax.r, (__m256i)iv36.r, (__m256i)iv0.r, (__m256i)iv_240.r, (__m256i)ivmin.r);
  ...
  allTwoPermRep(vectorFullLongTest, FUN2TEST, (__m256i)lvmax.r, (__m256i)lv36.r, (__m256i)lv0.r, (__m256i)lv_240.r, (__m256i)lvmin.r);
