...
#ifndef EIGEN_MIPP_PREDUX_MUL_TEST_H
#define EIGEN_MIPP_PREDUX_MUL_TEST_H

#undef FUN2TEST
#define FUN2TEST predux_mul

void predux_mulTests() {
...
#endif  // EIGEN_MIPP_PREDUX_MUL_TEST_H
