  ...
  {                                                                                                                \
    try {                                                                                                          \
      ...
      mipp::Reg<type> res4_old = cast(p4_old[3]);                                                                  \
                                                                                                                   \
      hasFailed |= printWhenDiff(                                                                                  \
          (bitwiseEq(res1, res1_old) || bitwiseEq(res2, res2_old) || bitwiseEq(res3, res3_old) ||                  \
           bitwiseEq(res4, res4_old)),                                                                             \
          #name "(" + to_string(tab) + ")", to_string(res1) + to_string(res2) + to_string(res3) + to_string(res4), \
